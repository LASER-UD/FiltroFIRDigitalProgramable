...
/* VD */
#define VD_viDAC8__CR0 CYREG_DAC1_CR0
#define VD_viDAC8__CR1 CYREG_DAC1_CR1
#define VD_viDAC8__D CYREG_DAC1_D
#define VD_viDAC8__PM_ACT_CFG CYREG_PM_ACT_CFG8
#define VD_viDAC8__PM_ACT_MSK 0x02u
#define VD_viDAC8__PM_STBY_CFG CYREG_PM_STBY_CFG8
#define VD_viDAC8__PM_STBY_MSK 0x02u
#define VD_viDAC8__STROBE CYREG_DAC1_STROBE
#define VD_viDAC8__SW0 CYREG_DAC1_SW0
#define VD_viDAC8__SW2 CYREG_DAC1_SW2
#define VD_viDAC8__SW3 CYREG_DAC1_SW3
#define VD_viDAC8__SW4 CYREG_DAC1_SW4
#define VD_viDAC8__TR CYREG_DAC1_TR
#define VD_viDAC8__TRIM__M1 CYREG_FLSHID_CUST_TABLES_DAC1_M1
#define VD_viDAC8__TRIM__M2 CYREG_FLSHID_CUST_TABLES_DAC1_M2
#define VD_viDAC8__TRIM__M3 CYREG_FLSHID_CUST_TABLES_DAC1_M3
#define VD_viDAC8__TRIM__M4 CYREG_FLSHID_CUST_TABLES_DAC1_M4
#define VD_viDAC8__TRIM__M5 CYREG_FLSHID_CUST_TABLES_DAC1_M5
#define VD_viDAC8__TRIM__M6 CYREG_FLSHID_CUST_TABLES_DAC1_M6
#define VD_viDAC8__TRIM__M7 CYREG_FLSHID_CUST_TABLES_DAC1_M7
#define VD_viDAC8__TRIM__M8 CYREG_FLSHID_CUST_TABLES_DAC1_M8
#define VD_viDAC8__TST CYREG_DAC1_TST
...
/* LEDS */
#define LEDS__0__INTTYPE CYREG_PICU2_INTTYPE1
#define LEDS__0__MASK 0x02u
#define LEDS__0__PC CYREG_PRT2_PC1
#define LEDS__0__PORT 2u
#define LEDS__0__SHIFT 1u
#define LEDS__AG CYREG_PRT2_AG
#define LEDS__AMUX CYREG_PRT2_AMUX
#define LEDS__BIE CYREG_PRT2_BIE
#define LEDS__BIT_MASK CYREG_PRT2_BIT_MASK
#define LEDS__BYP CYREG_PRT2_BYP
#define LEDS__CTL CYREG_PRT2_CTL
#define LEDS__DM0 CYREG_PRT2_DM0
#define LEDS__DM1 CYREG_PRT2_DM1
#define LEDS__DM2 CYREG_PRT2_DM2
#define LEDS__DR CYREG_PRT2_DR
#define LEDS__INP_DIS CYREG_PRT2_INP_DIS
#define LEDS__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define LEDS__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define LEDS__LCD_EN CYREG_PRT2_LCD_EN
#define LEDS__MASK 0x02u
#define LEDS__PORT 2u
#define LEDS__PRT CYREG_PRT2_PRT
#define LEDS__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define LEDS__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define LEDS__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define LEDS__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define LEDS__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define LEDS__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define LEDS__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define LEDS__PS CYREG_PRT2_PS
#define LEDS__SHIFT 1u
#define LEDS__SLW CYREG_PRT2_SLW
...
#define Salida_1__0__INTTYPE CYREG_PICU1_INTTYPE6
#define Salida_1__0__MASK 0x40u
#define Salida_1__0__PC CYREG_PRT1_PC6
#define Salida_1__0__PORT 1u
#define Salida_1__0__SHIFT 6u
#define Salida_1__AG CYREG_PRT1_AG
#define Salida_1__AMUX CYREG_PRT1_AMUX
#define Salida_1__BIE CYREG_PRT1_BIE
#define Salida_1__BIT_MASK CYREG_PRT1_BIT_MASK
#define Salida_1__BYP CYREG_PRT1_BYP
#define Salida_1__CTL CYREG_PRT1_CTL
#define Salida_1__DM0 CYREG_PRT1_DM0
#define Salida_1__DM1 CYREG_PRT1_DM1
#define Salida_1__DM2 CYREG_PRT1_DM2
#define Salida_1__DR CYREG_PRT1_DR
#define Salida_1__INP_DIS CYREG_PRT1_INP_DIS
#define Salida_1__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Salida_1__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Salida_1__LCD_EN CYREG_PRT1_LCD_EN
#define Salida_1__MASK 0x40u
#define Salida_1__PORT 1u
#define Salida_1__PRT CYREG_PRT1_PRT
#define Salida_1__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Salida_1__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Salida_1__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Salida_1__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Salida_1__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Salida_1__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Salida_1__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Salida_1__PS CYREG_PRT1_PS
#define Salida_1__SHIFT 6u
#define Salida_1__SLW CYREG_PRT1_SLW

/* Pin_ADC */
#define Pin_ADC__0__INTTYPE CYREG_PICU1_INTTYPE7
#define Pin_ADC__0__MASK 0x80u
#define Pin_ADC__0__PC CYREG_PRT1_PC7
#define Pin_ADC__0__PORT 1u
#define Pin_ADC__0__SHIFT 7u
#define Pin_ADC__AG CYREG_PRT1_AG
#define Pin_ADC__AMUX CYREG_PRT1_AMUX
#define Pin_ADC__BIE CYREG_PRT1_BIE
#define Pin_ADC__BIT_MASK CYREG_PRT1_BIT_MASK
#define Pin_ADC__BYP CYREG_PRT1_BYP
#define Pin_ADC__CTL CYREG_PRT1_CTL
#define Pin_ADC__DM0 CYREG_PRT1_DM0
#define Pin_ADC__DM1 CYREG_PRT1_DM1
#define Pin_ADC__DM2 CYREG_PRT1_DM2
#define Pin_ADC__DR CYREG_PRT1_DR
#define Pin_ADC__INP_DIS CYREG_PRT1_INP_DIS
#define Pin_ADC__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Pin_ADC__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Pin_ADC__LCD_EN CYREG_PRT1_LCD_EN
#define Pin_ADC__MASK 0x80u
#define Pin_ADC__PORT 1u
#define Pin_ADC__PRT CYREG_PRT1_PRT
#define Pin_ADC__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Pin_ADC__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Pin_ADC__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Pin_ADC__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Pin_ADC__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Pin_ADC__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Pin_ADC__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Pin_ADC__PS CYREG_PRT1_PS
#define Pin_ADC__SHIFT 7u
#define Pin_ADC__SLW CYREG_PRT1_SLW

/* Pin_PWM */
#define Pin_PWM__0__INTTYPE CYREG_PICU3_INTTYPE0
#define Pin_PWM__0__MASK 0x01u
#define Pin_PWM__0__PC CYREG_PRT3_PC0
#define Pin_PWM__0__PORT 3u
#define Pin_PWM__0__SHIFT 0u
#define Pin_PWM__AG CYREG_PRT3_AG
#define Pin_PWM__AMUX CYREG_PRT3_AMUX
#define Pin_PWM__BIE CYREG_PRT3_BIE
#define Pin_PWM__BIT_MASK CYREG_PRT3_BIT_MASK
#define Pin_PWM__BYP CYREG_PRT3_BYP
#define Pin_PWM__CTL CYREG_PRT3_CTL
#define Pin_PWM__DM0 CYREG_PRT3_DM0
#define Pin_PWM__DM1 CYREG_PRT3_DM1
#define Pin_PWM__DM2 CYREG_PRT3_DM2
#define Pin_PWM__DR CYREG_PRT3_DR
#define Pin_PWM__INP_DIS CYREG_PRT3_INP_DIS
#define Pin_PWM__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU3_BASE
#define Pin_PWM__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define Pin_PWM__LCD_EN CYREG_PRT3_LCD_EN
#define Pin_PWM__MASK 0x01u
#define Pin_PWM__PORT 3u
#define Pin_PWM__PRT CYREG_PRT3_PRT
#define Pin_PWM__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define Pin_PWM__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define Pin_PWM__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define Pin_PWM__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define Pin_PWM__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define Pin_PWM__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define Pin_PWM__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define Pin_PWM__PS CYREG_PRT3_PS
#define Pin_PWM__SHIFT 0u
#define Pin_PWM__SLW CYREG_PRT3_SLW
