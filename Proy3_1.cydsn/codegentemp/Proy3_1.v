// ======================================================================
// Proy3_1.v generated from TopDesign.cysch
// 06/26/2019 at 10:06
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=1600, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VD, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VD, CY_INSTANCE_SHORT_NAME=VD, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=VD, )
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("91cd31a7-36c1-4f80-8357-da335805490d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("7c30225d-6761-49c5-afe8-30d9398f994b"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("feef4479-6dd7-494b-8640-44c5442647ae"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    VDAC8_v1_90_5 VD (
        ...
        .data(8'b00000000),
        .vOut(Net_239));
    defparam VD.Data_Source = 0;
    defparam VD.Initial_Value = 100;
    defparam VD.Strobe_Mode = 0;

	wire [0:0] tmpOE__Salida_1_net;
	wire [0:0] tmpFB_0__Salida_1_net;
	wire [0:0] tmpIO_0__Salida_1_net;
	wire [0:0] tmpINTERRUPT_0__Salida_1_net;
	electrical [0:0] tmpSIOVREF__Salida_1_net;

	cy_psoc3_pins_v1_10
		#(.id("a2b6bd16-8afd-4314-af8b-c81433d4c0c8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Salida_1
		 (.oe(tmpOE__Salida_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Salida_1_net[0:0]}),
		  .analog({Net_239}),
		  .io({tmpIO_0__Salida_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Salida_1_net),
		  .interrupt({tmpINTERRUPT_0__Salida_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Salida_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
