...
// DVDAC_v2_10(DAC_Range=4, Initial_Value=0, InternalClock=true, InternalClockFreqHz=250000, Resolution=10, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=DVDAC_v2_10, CY_CONFIG_TITLE=DAC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DAC, CY_INSTANCE_SHORT_NAME=DAC, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=DAC, )
...
module CharLCD_v2_20_5 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("3f79333e-b1c1-45cc-93a9-48079382e27b/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    Timer_v2_80_0 Muestreo (
        ...
        .tc(Net_15),
        .clock(Net_10));
    defparam Muestreo.CaptureCount = 2;
    defparam Muestreo.CaptureCounterEnabled = 0;
    defparam Muestreo.DeviceFamily = "PSoC5";
    defparam Muestreo.InterruptOnCapture = 0;
    defparam Muestreo.InterruptOnTC = 0;
    defparam Muestreo.Resolution = 8;
    defparam Muestreo.SiliconRevision = "0";
	...
	wire [2:0] tmpOE__Columnas_net;
	wire [2:0] tmpFB_2__Columnas_net;
	wire [2:0] tmpIO_2__Columnas_net;
	...
	cy_psoc3_pins_v1_10
		...
		Columnas
		 (.oe(tmpOE__Columnas_net),
		  .y({3'b0}),
		  .fb({tmpFB_2__Columnas_net[2:0]}),
		  .io({tmpIO_2__Columnas_net[2:0]}),
	...
	assign tmpOE__Columnas_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};

	wire [3:0] tmpOE__Filas_net;
	wire [3:0] tmpFB_3__Filas_net;
	wire [3:0] tmpIO_3__Filas_net;
	wire [0:0] tmpINTERRUPT_0__Filas_net;
	...
	cy_psoc3_pins_v1_10
		...
		Filas
		 (.oe(tmpOE__Filas_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__Filas_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
    ...
    Timer_v2_80_4 Recorre_Uno (
        ...
        .tc(Net_54),
        .clock(Net_46));
    defparam Recorre_Uno.CaptureCount = 2;
    defparam Recorre_Uno.CaptureCounterEnabled = 0;
    defparam Recorre_Uno.DeviceFamily = "PSoC5";
    defparam Recorre_Uno.InterruptOnCapture = 0;
    defparam Recorre_Uno.InterruptOnTC = 0;
    defparam Recorre_Uno.Resolution = 24;
    defparam Recorre_Uno.SiliconRevision = "0";
